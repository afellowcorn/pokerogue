...
export const move: MoveTranslationEntries = {
  "pound": {
    name: "Grom",
    effect: "Cel jest uderzony długim ogonem, nogą, lub podobnym."
  },
  "karateChop": {
    name: "Cios Karate",
    effect: "Cel jest zaatakowany ostrym ciosem. Krytyczne uderzenia są bardziej prawdopodobne."
  },
  "doubleSlap": {
    name: "Dwuklask",
    effect: "Cel jest spoliczkowany wielokrotnie, od dwóch do pięciu razy pod rząd."
  },
  "cometPunch": {
    name: "Cios Komety",
    effect: "Cel jest uderzony pięścią od dwóch do pięciu razy pod rząd."
  },
  "megaPunch": {
    name: "Megacios",
    effect: "Cel jest uderzony pięścią z pełną siłą mięśni."
  },
  "payDay": {
    name: "Dzień Zapłaty",
    effect: "Duża ilość monet jest rzucona w cel. Po bitwie zyskuje się pieniądze."
  },
  "firePunch": {
    name: "Ognisty Cios",
    effect: "Cel jest uderzony ognistą pięścią. Może także oparzyć cel."
  },
  "icePunch": {
    name: "Lodowy Cios",
    effect: "Cel jest uderzony lodowatą pięścią. Może także zamrozić cel."
  },
  "thunderPunch": {
    name: "Cios Gromu",
    effect: "Cel jest uderzony zelektryzowaną pięścią. Może także sparaliżować cel."
  },
  "scratch": {
    name: "Rysa",
    effect: "Cel jest podrapany twardymi, ostrymi pazurami."
  },
  "viseGrip": {
    name: "Kleszcze",
    effect: "Cel jest złapany i ściśnięty z obu stron."
  },
  "guillotine": {
    name: "Gilotyna",
    effect: "Okrutny atak dużymi szczypcami. Cel od razu mdleje jeśli ten atak trafi."
  },
  "razorWind": {
    name: "Cios Wiatru",
    effect: "W tym dwu turowym ataku, wiatr uderza w przeciwnego Pokémona w drugiej turze. Krytyczne uderzenia są bardziej prawdopodobne."
  },
  "swordsDance": {
    name: "Taniec Szabli",
    effect: "Szalony taniec który ożywia ducha walki. Ostro podnosi Atak użytkownika."
  },
  "cut": {
    name: "Cięcie",
    effect: "Cel jest cięty pazurem."
  },
  "gust": {
    name: "Podmuch Wiatru",
    effect: "Podmuch wiatru jest stworzony prez skrzydła Pokémona i rzucony w cel."
  },
  "wingAttack": {
    name: "Atak Skrzydeł",
    effect: "Cel jest uderzony dużymi skrzydłami."
  },
  "whirlwind": {
    name: "Cyklon",
    effect: "Cel jest zdmuchnięty i inny Pokémon jest wyciągnięty na pole walki. W dziczy kończy bitwę z pojedyńczym Pokémonem."
  },
  "fly": {
    name: "Lot",
    effect: "Użytkownik leci w górę i uderza swój cel w następnej turze."
  },
  "bind": {
    name: "Związanie",
  ...
  "vineWhip": {
    name: "Dzikie Pnącze",
    effect: "Cel jest uderzony smukłym pnączem."
  },
  "stomp": {
    name: "Tupnięcie",
    effect: "Cel jest tupnięty dużą stopą. Może też sprawić że cel się wzdrygnie."
  },
  "doubleKick": {
    name: "Podwójne Kopnięcie",
    effect: "Cel jest szybko kopnięty dwa razy pod rząd używając obu stóp."
  },
  "megaKick": {
    name: "Megakop",
    effect: "Cel jest zaatakowany kopnięciem z pełną siłą mięśni."
  },
  "jumpKick": {
    name: "Skokokop",
    effect: "Użytkownik skacze wysoko, a następnie kopie przeciwnika. Jeśli kopnięcie chybi, użytkownik krzywdzi siebie."
  },
  "rollingKick": {
    name: "Kop Obrotowy",
  ...
  "sandAttack": {
    name: "Atak Piaskiem",
    effect: "Piasek jest rzucony w twarz przeciwnika, obniżając jego celność."
  },
  "headbutt": {
    name: "Taran",
    effect: "Użytkownik wystawia swoją głowę i atakuje szarżując prosto w cel. Może też sprawić że cel się wzdrygnie."
  },
  "hornAttack": {
    name: "Atak Rogu",
    effect: "Cel jest dźgnięty ostrym rogiem."
  },
  "furyAttack": {
    name: "Atak Furii",
    effect: "Cel jest dźgnięty rogiem lub dziobem wielokrotnie, od dwóch do pięciu razy pod rząd."
  },
  "hornDrill": {
    name: "Świdroróg",
    effect: "Cel jest zaatakowany rogiem, który obraca się jak wiertarka. Cel od razu mdleje jeśli ten atak trafi."
  },
  "tackle": {
    name: "Akcja",
    effect: "Fizyczny atak, w którym użytkownik uderza w cel całym swoim ciałem."
  },
  "bodySlam": {
    name: "Powalenie",
    effect: "Użytkownik opada na cel całym swoim ciężarem. Może także sparaliżować cel."
  },
  "wrap": {
    name: "Ściskanie",
    effect: "Długie ciało, pnącze lub podobne są użytę by związać i ścisnąć cel przez cztery do pięciu tur."
  },
  "takeDown": {
    name: "Usunięcie",
